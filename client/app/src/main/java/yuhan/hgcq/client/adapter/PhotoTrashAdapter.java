...
public class PhotoTrashAdapter extends RecyclerView.Adapter<PhotoTrashAdapter.PhotoViewHolder> {
    ...
    public PhotoTrashAdapter(List<PhotoDTO> photoList, Context context, boolean isPrivate) {
