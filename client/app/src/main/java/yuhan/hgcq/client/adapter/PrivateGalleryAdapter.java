...
public class PrivateGalleryAdapter extends RecyclerView.Adapter<PrivateGalleryAdapter.ServerGalleryViewHolder> {
    ...
    public PrivateGalleryAdapter(Map<String, List<PhotoDTO>> gallery, Context context, boolean isPrivate,
    ...
    public void onBindViewHolder(@NonNull ServerGalleryViewHolder holder, int position) {
        ...
        PrivateGalleryPhotoAdapter pgpa = new PrivateGalleryPhotoAdapter(photoList, context);
        pgpa.setOnItemClickListener(new PrivateGalleryPhotoAdapter.OnItemClickListener() {
            @Override
        ...
        holder.photoListView.setAdapter(pgpa);
    }
