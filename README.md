...
### 👧 조서윤
프로젝트의 디자인을 담당하며, 디자인이 앱 전체 흐름의 큰 영향을 준다는 걸 느꼈습니다. 처음에는 단순히 보기 좋은 화면을 만드는 것이 디자인의 주요 역할이라고 생각했지만, 프로젝트가 진행될수록 디자인이 앱의 구조와 흐름, 사용자 경험 전반에 깊이 관여한다는 사실을 깨달았습니다. 특히 사진을 업로드하고, 앨범을 공유하고 피드백을 주고받는 과정을 사용자 입장에서 자연스럽고 직관적으로 느끼게 하기 위해 많은 고민이 필요했습니다.

또한 팀 프로젝트인 만큼 팀원들과의 소통이 중요했고, 서로 영역을 이해하려 노력하며 중간중간 지속적인 피드백은 결과적으로 앱의 완성도를 높이는데 큰 도움을 받았습니다. 이번 프로젝트를 통해서 협업의 중요성과 재미 또한 배울 수 있었습니다. 앞으로 이런 경험을 바탕으로 더 나은 프로젝트의 결과물과 팀워크를 만들어나가고 싶습니다.
